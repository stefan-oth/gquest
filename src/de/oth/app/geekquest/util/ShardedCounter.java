package de.oth.app.geekquest.util;
...
public class ShardedCounter {
    ...
    public final void increment(long value) {
        ...
        incrementPropertyTx(shardKey, CounterShard.COUNT, value, value);
      
        mc.increment(kind, value);
    }
    
    /**
     * Increment the value of this sharded counter by one.
     */
    ...
    /**
     * Decrement the value of this sharded counter by the given value.
     */
    public final void decrement(long value) {
        
        long decValue = value * -1;
        ...
        Key shardKey = KeyFactory.createKey(kind, Long.toString(shardNum));
        incrementPropertyTx(shardKey, CounterShard.COUNT, decValue, decValue);
      
        mc.increment(kind, decValue);
    }
    
    /**
     * Decrement the value of this sharded counter by one.
     */
